...
export const ENDING_TEXTS: Record<EndingType, {
  ...
  insight: {
    ...
    trueStory: '你已触及真相的全貌，却未能握住将其彻底拉向阳光的那根绳索。暗账本、马六的证词、秦氏的密会记忆——这些证据中至少还缺两条，才能让刘万全无处遁形。',
    hint: '提示：需同时掌握暗账本、马六承认充当中间人、秦氏的秘密会面中的至少两项，才能达成「真相大白」。',
  },
  basic: {
    title: '就案结案',
    subtitle: '基础结局',
    ...
    hint: '提示：深入调查刘万全、书房暗账本、马六与秦氏，或可发现此案幕后的私盐走私网络。',
  },
  failure: {
    title: '冤假错案',
    subtitle: '失败结局',
    ...
    hint: '提示：仔细检查陈四的不在场证明、锁具撬痕方向，以及库房备用钥匙的下落。',
  },
};
